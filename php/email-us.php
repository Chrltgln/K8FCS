...
<body>
    ...
    <section class="contact-container">
        <div class="container">
            ...
            <div class="right-section">
                ...
                <form action="process/send-email-client-question.php" method="POST" id="contact-input-container" onsubmit="return confirmSubmission(event)">
    ...
    <div class="contact-container" id="second-contact-container">
        <div class="contact-item">
            ...
            <p><strong>Address:</strong> Phase 1 Block 37 Lot 2-A Mary Cris Complex Pasong Camachile 2 General Trias,
                Cavite</p>
        </div>
