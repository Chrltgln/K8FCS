...
<body>
    ...
    <div class="main-content">
        <div class="form-container">
            ...
            <form id="application-form" action="process/process_sangla_orcr.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-inputs">
                        ...
                        <div class="form-group">
                            <label for="middle-name">Middle Name: <span
                                    class="required-asterisk">*</span></label>
                            <input type="text" id="middle-name" name="middle_name" placeholder="A" required
            ...
            <div class="form-page" id="page-2" style="display: none;">
                ...
                <div class="form-page" id="page-4" style="display: none;">
                    ...
                    <div class="form-inputs">
                        ...
                        <div class="form-group">
                            <label for="father-middle-name">Father's Middle Name:</label>
                            <input type="text" id="father-middle-name" name="father_middle_name" placeholder="Rivera">
                        </div>
                        <div class="form-group">
                            <label for="father-last-name">Father's Last Name:</label>
                            <input type="text" id="father-last-name" name="father_last_name" placeholder="Doe">
                ...
                <div class="form-page" id="page-5" style="display: none;">
                    ...
                    <div class="form-group">
                            ...
                            <div class="file-upload-wrapper">
                                <input type="file" id="combined-file" name="combined_file[]" multiple required>
