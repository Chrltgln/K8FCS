...
<body>
    ...
    <div class="main-content">
        <div class="form-container">
            ...
            <form id="application-form" action="process/process_brand_new_form.php" method="post">
                ...
                <div class="form-page" id="page-1">
                    ...
                    <div class="form-inputs">
                        ...
                        <div class="form-group">
                            ...
                            class="required-asterisk">*</span></label>
                            <input type="text" id="middle-name" name="middle_name" placeholder="Cruz" required
                    ...
                    <div class="form-inputs">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" id="email-address-borrower" name="email_address_borrower"
                                placeholder="ellen@gmail.com" required>
                                <span class="error-message"></span>
                        </div>
                        <div class="form-group">
